...
namespace GamesTan.Spatial {
    ...
    public unsafe struct Grid {
        ...
        [FieldOffset(8)] public fixed Int64 Entities[ArySize];
        public bool IsLocalFull => Count >= ArySize;
        public bool HasExtData => NextGridPtr == 0;


        public void GetEntities(List<EntityIdType> lst) {
            if(Count ==0) return;
            fixed (void* ptr = &this.Count) {
                ...
                for (int i = 0; i < Count; i++) {
                    ...
                    lst.Add((EntityIdType)curGrid->Entities[offset]);
                }
            }
        ...
        static List<EntityIdType> _debugTempDatas = new List<EntityIdType>();

        public List<EntityIdType> ToDebugList() {
